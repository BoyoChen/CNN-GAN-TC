...
# ------------
# based on generator_2_1
# Not using VIS "AND PMW" channel as feature in generator!
# ------------
...
class Model(tf.keras.Model):
    # a modified U-Net
    def __init__(self, output_channel_num=2):
        super().__init__()
    ...
    def call(self, image, feature, target_minutes_to_noon, training=False):
        down_sample_stages = []
        ...
        fake_VIS = tf.gather(output, axis=-1, indices=[0])
        fake_PMW = tf.gather(output, axis=-1, indices=[1])
        return fake_VIS, fake_PMW
